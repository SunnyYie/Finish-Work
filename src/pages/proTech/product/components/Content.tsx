import { Button, DatePicker, Descriptions, Divider, Form, FormInstance, Input, Message, Modal, Space, Spin, Table, Tabs, Tag } from '@arco-design/web-react'
...
const Content = (props) => {
  ...
  return (
    <>
      ...
      <DrawerProduct visible={visible} setVisible={setVisible} productId={props.data._id} setUpdated={props.setUpdated} />
    </>
  )
}
