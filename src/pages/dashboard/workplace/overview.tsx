...
import { Grid, Card, Typography, Divider, Skeleton, Link, Space } from '@arco-design/web-react'
...
function StatisticItem(props: StatisticItemType) {
  const { icon, title, count, loading, unit, onClick } = props
  return (
      ...
      <Row>
        <Col span={12}>
          <StatisticItem
            ...
            onClick={() => {
              history.push('/dashboard/workplace/todo')
            }}
          />
        </Col>
        <Col span={12}>
          <StatisticItem icon={<IconContent />} title={'流程监控'} count={data.traffic} loading={loading} unit={t['workplace.pecs']} />
        </Col>
      </Row>
      <Divider />
      <Row>
