...
import { IconDashboard, IconTag, IconMenuFold, IconMenuUnfold, IconCheckSquare, IconFile, IconFolder, IconThunderbolt, IconApps } from '@arco-design/web-react/icon'
  ...
  return (
    <Layout className={styles.layout}>
      ...
      {userLoading ? (
        ...
        <Layout>
          {showMenu && (
            <Sider className={styles['layout-sider']} width={menuWidth} collapsed={collapsed} onCollapse={setCollapsed} trigger={null} collapsible breakpoint="xl" style={paddingTop}>
